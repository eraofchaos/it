 ...
 **Required Level to open:** 1
 ...
 1 You would get **ALL** items  from:
  ...
  | 2 | [Pacchetto Eroi Élite](/it/Items/con_1739/) | Aprilo per ottenere 1 ricompensa a tua scelta tra le seguenti: 40 token Roland, 40 token Kilgor, 40 token Sandro, 40 token Astral, 40 token Mutare (drago), 40 token Xeron, 40 token Ciele o 40 token Tazar. | 
