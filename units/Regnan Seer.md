 ...
 **Descrizione:** <span style="color: #645252;font-size:20px">PF della Veggente di Regna aumentati (</span><span style="color: black"><span style="color: #48b946;font-size:20px"><span id="str3"></span>%</span><span style="color: black"><span style="color: #645252;font-size:20px">). Quando i suoi PF scendono sotto il 40%, evoca un Serpente di Regna e &lt;stordisce&gt; tutte le unità nemiche per </span><span style="color: black"><span style="color: #48b946;font-size:20px"><span id="str4"></span></span><span style="color: black"><span style="color: #645252;font-size:20px"> secondi. Quando i suoi PF scendono al 10%, lancia <span style="color: #F0F000;font-size:20px">&lt;Protezione cerulea&gt;</span><span style="color: black">.
