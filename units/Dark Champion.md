 ...
 **Descrizione:** <span style="color: #645252;font-size:20px">DAN e Rid DAN delle unità aumentano del (</span><span style="color: black"><span style="color: #48b946;font-size:20px"><span id="str6"></span>%</span><span style="color: black"><span style="color: #645252;font-size:20px">). I PF ottenuti tramite &lt;Destino finale&gt; aumentano di un ulteriore 4% per ogni unità Necropoli sul campo di battaglia. I PF ottenuti tramite &lt;Destino finale&gt; aumentano di un ulteriore 1% per ogni unità Necropoli evocata sul campo di battaglia. &lt;Destino finale&gt; può aumentare i PF fino a un massimo di 25%. Quando un eroe alleato lancia un incantesimo di tipo Terra, riduce di 4 secondi il recupero di 1 incantesimo casuale.</span><span style="color: black">
