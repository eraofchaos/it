 ...
 **Esclusivo for Unit:** [Orco](/units/Orc/) 
...
## Rango ↑
  ...
  | **4x** <i class="fas fa-star"/> | ? | Tenacia dell'Orco aumentata di 400. |
  | **5x** <i class="fas fa-star"/> | ? | Ogni volta che viene schierata un'unità Roccaforte, il DAN dell'Orco aumenta del 4%. |
  | **6x** <i class="fas fa-star"/> | ? | Gli attacchi base hanno il 5% di probabilità di attivare <Lancio dell'ascia>. Recupero: 3 secondi. |
