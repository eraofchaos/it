...
## Details
 **Name: Falce diabolica** 

 **Esclusivo for Unit:** [Diavolo](/units/Devil/) 
...
## Rango ↑
  ...
  | **4x** <i class="fas fa-star"/> | ? | Il Diavolo gode di ATT aumentato del 20% e DIF aumentata del 10%. |
  | **5x** <i class="fas fa-star"/> | ? | Ogni 30 secondi, il Diavolo applica <Combustione> a tutte le unità nemiche per 10 secondi. Attesa iniziale: 5 secondi. |
  | **6x** <i class="fas fa-star"/> | ? | Ogni 10 secondi, il Diavolo colpisce l'unità bersaglio con <Tortura infernale>. Quando usa <Tortura infernale>, tutte le unità Inferno godono di DAN CRIT aumentato del 10% e Vel ATT aumentata del 10% per 5 secondi. <Tortura infernale> infligge danni pari al 100% dell'ATT +5% dei PF massimi del bersaglio a tutte le unità nemiche in un'area. Effetto raddoppiato contro le unità affette da <Combustione>. |
