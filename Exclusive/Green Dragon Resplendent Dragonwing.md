...
## Rango ↑
  ...
  |:-------------|:---------------:|:---------------:|
  |  Risveglio  | **100x** [Token Ala di drago splendente](/ItemsIT/con_976/) | Quando il Drago verde ottiene uno <scudo>, le unità Baluardo alleate ottengono a loro volta uno <scudo> pari al 10% dei PF massimi per 10 secondi. Recupero: 15 secondi. |
  ...
  | **3x** <i class="fas fa-star"/> | **130x** [Token Ala di drago splendente](/ItemsIT/con_976/) | <Protezione cristallina> La pelle cristallizzata del Drago verde annulla 5 istanze di danno. Dopo aver bloccato il danno per la quinta volta, <Protezione cristallina> svanisce e tutte le unità alleate diventano temporaneamente immuni al <Veleno> e allo <Stordimento>, liberandosi eventualmente di questi effetti se già inflitti. Aumenta anche la Rid DAN del 20% per 3 secondi. <Protezione cristallina> può attivarsi una volta ogni 15 secondi. |
  ...
  | **5x** <i class="fas fa-star"/> | **210x** [Token Ala di drago splendente](/ItemsIT/con_976/) | <Inarrestabile> Se l'unità attaccata è <rallentata>, subisce danni pari al 100% dell'ATT e viene <accecata> per 5 secondi. Recupero: 18 secondi. Se l'unità attaccata è affetta da <Sanguinamento>, subisce danni pari al 100% dell'ATT e la sua DIF si riduce del 15%. Durata: 5 secondi. Recupero: 18 secondi. |
  | **6x** <i class="fas fa-star"/> | **250x** [Token Ala di drago splendente](/ItemsIT/con_976/) | <Spine di diamante> Evoca e scaglia un'immensa quantità di affilatissimi cristalli, che infliggono danni pari al 100% dell'ATT alle unità nemiche in un'ampia area di fronte a sé. Danno raddoppiato contro bersagli <rallentati>. Recupero: 21 secondi. |
