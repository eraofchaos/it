...
## Extra bonus
  ...
  |:---|:-------|:------------|
  | **10** | Aumenta l'Intelligenza di tutti gli eroi alleati di 30. | **+1500** |
  | **20** | <Confluenza inarrestabile> Riduce di un ulteriore 15% la resistenza magica di tutte le unità nemiche. | - |
  | **30** | Aumenta la Sapienza di tutti gli eroi alleati di 60. | **+1500** |
  | **40** | <Confluenza inarrestabile> Aumenta di un ulteriore 50% il danno magico degli eroi alleati. | - |
