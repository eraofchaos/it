 ...
 **Specialità eroe:** Crociato corazzato
 ...
 **Mana recovery:** 5.0
  ...
  |---------|:---------------:|:---------------:|:--|--------------------|
  |    1    | 8 | 8 | **30x** [Caterina](/ItemsIT/her_361/) | Se Caterina è sul campo di battaglia, gli Spadaccini diventano Crociati corazzati e i loro PF aumentano del 20% |
  |    2    | 12 | 12 | **50x** [Caterina](/ItemsIT/her_361/) | Se godono di <Morale alto>, i Crociati corazzati ottengono uno <scudo> pari al 10% dei propri PF |
  |    3    | 16 | 16 | **100x** [Caterina](/ItemsIT/her_361/) | I danni subiti dai Crociati corazzati si riducono del 20%. La tecnica <Gioia> si trasforma nella tecnica <Scudo d'Aria - Adunata>. |
  |    4    | 20 | 20 | **150x** [Caterina](/ItemsIT/her_361/) | L'unità di Crociati corazzati passa da 9 a 16 membri |
 ...
 **Descrizione 2:** Al prossimo livello, il DAN accumulato aumenta di <span style="color: #00ff22;font-size:16px">{$ovalueadd12*($olast11/$ointerval)}</span><span style="color: black">.

 **Descrizione 3:** I nemici subiscono danni prolungati nel tempo.

 **Descrizione 4:** Evoca una tempesta di grandine che infligge <span style="color: #48b946;font-size:20px"></span><span style="color: black">danni continui da Acqua. Congela i bersagli <span style="color: #f0f000;font-size:18px">rallentati</span><span style="color: black">.
