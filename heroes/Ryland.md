 ...
 **Specialità eroe:** Guardia Dendroide
 ...
 **Mana recovery:** 5.0
  ...
  |---------|:---------------:|:---------------:|:--|--------------------|
  |    1    | 8 | 8 | **30x** [Ryland](/ItemsIT/her_368/) | Le Guardie Dendroidi diventano Guardiani della foresta. La tecnica <Rullo stritolante> protegge tutte le unità di difesa alleate con uno <scudo> aggiuntivo. |
  |    2    | 12 | 12 | **50x** [Ryland](/ItemsIT/her_368/) | I PF delle Guardie Dendroidi e dei Guardiani della foresta aumentano del 30%. |
  |    3    | 16 | 16 | **100x** [Ryland](/ItemsIT/her_368/) | L'effetto dello <scudo> generato da <Rullo stritolante> del Guardiano della foresta è raddoppiato. |
  |    4    | 20 | 20 | **150x** [Ryland](/ItemsIT/her_368/) | Gli effetti di guarigione dei Guardiani della foresta e delle Guardie Dendroidi evocati con <Riverbero silvano> aumentano del 50% |
...
### 3 Incantesimo: Riverbero silvano
 ...
 **Descrizione 2:** Al prossimo livello, il livello dei Dendroidi aumenta di <span style="color: #00ff22;font-size:16px">1</span><span style="color: black">, l'ATT aumenta di <span style="color: #00ff22;font-size:16px">60</span><span style="color: black"> e i PF aumentano di <span style="color: #00ff22;font-size:16px">1391</span><span style="color: black">.

 **Descrizione 3:** Evoca Dendroide minore

 **Descrizione 4:** Evoca 9 Dendroidi nell'area bersaglio.

### 4 Incantesimo: Preghiera
 ...
 **Descrizione 2:** Al prossimo livello, la rigenerazione dei PF accumulata aumenta di <span style="color: #00ff22;font-size:16px">{$ovalueadd12*($olast11/$ointerval)}</span><span style="color: black">.

 **Descrizione 3:** Cura e protegge le unità alleate.

 **Descrizione 4:** Cura ininterrottamente le unità alleate. Guarigione raddoppiata per le unità protette da uno <span style="color: #f0f000;font-size:18px">scudo</span><span style="color: black">.
